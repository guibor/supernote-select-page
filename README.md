# Supernote Select Page

Select Page is a small Supernote plugin that selects every element on the
...
- Adds a `Select Page` button to the NOTE toolbar.
...
```text
build/outputs/supernote_select_page.snplg
```
